 ...
 */
interface HomeDesaBlogInterface
{
    /**
     ...
     *
     * @param  HomeDesaBlogStoreRequest  $request  The request containing data for the new blog post.
     ...
     *
     * @param  HomeDesaBlogUpdateRequest  $request  The request containing updated data for the blog post.
    ...
    /**
     * Update the general blog of a blog post.
     *
     * @param  string  $id  The ID of the blog post to update.
     * @return bool True if the general blog was successfully updated, false otherwise.
     */
