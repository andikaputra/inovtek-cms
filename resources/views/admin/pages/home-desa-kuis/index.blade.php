...
@section('title', 'Kuis Wilayah | Data Kuis Wilayah')

@section('customJs')
    @include('admin.pages.home-desa-kuis.js._index_js')
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Kuis Wilayah - Data Kuis Wilayah</h3>
                </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body pt-3 pb-2">
                            <div class="row justify-content-between g-2">
                                <div class="col-auto">
                                    <h6 class="py-0">Total Kuis (<span id="kuis-total"><small>...</small></span>) |
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row justify-content-between g-2">
                                <div class="col-auto">
                                    <a href="{{ route('admin.home.detail.kuis.create', ['id_provinsi' => $findRegion->slug]) }}"
