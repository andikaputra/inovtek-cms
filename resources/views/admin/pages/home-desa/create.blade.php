...
@section('title', 'Dashboard Desa | Buat Desa')
...
@section('customJs')
    <!-- Leaflet JS -->
    @include('admin.pages.home-desa.js._create_js')
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Dashboard Desa - Buat Desa</h3>
                </div>
                ...
                <div class="card-body">
                    <section id="basic-horizontal-layouts">
                        <form class="form form-horizontal"
                            action="{{ route('admin.home.detail.desa.store', $findRegion->slug) }}" method="POST">
                            @csrf
                            <div class="form-body">
                                <div class="row">
