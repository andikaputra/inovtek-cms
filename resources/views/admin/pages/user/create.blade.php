...
@section('customCss')
    @include('admin.pages.user.css._create_css')
@endsection

@section('customJs')
    @include('admin.pages.user.js._create_js')
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Manajemen User - Buat User</h3>
                </div>
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="email" required
                                                    ...
                                                    placeholder="Email User" name="email" value="{{ old('email') }}">
