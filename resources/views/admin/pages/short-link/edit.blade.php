        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Manajemen Short Link - Ubah Short Link</h3>
                </div>
                ...
                <div class="card-body">
                    <section id="basic-horizontal-layouts">
                        <form class="form form-horizontal"
                            action="{{ route('admin.short-link.update', $findShortLink->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="form-body">
                                <div class="row">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="url" required
                                                    ...
                                                    value="{{ old('original_url') ?? $findShortLink->original_url }}">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-check form-check-lg d-flex align-items-end">
                                            <input class="form-check-input me-2" type="checkbox" name="is_active"
                                                ...
                                                {{ $findShortLink->is_active ? 'checked' : '' }}>
