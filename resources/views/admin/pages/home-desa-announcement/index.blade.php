...
@section('title', 'Pengumuman | Data Pengumuman')

@section('customJs')
    @include('admin.pages.home-desa-announcement.js._index_js')
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Pengumuman - Data Pengumuman</h3>
                </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body pt-3 pb-2">
                            <div class="row justify-content-between g-2">
                                <div class="col-auto">
                                    <h6 class="py-0">Total Pengumuman (<span
                                            id="pengumuman-total"><small>...</small></span>) |
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row justify-content-between g-2">
                                <div class="col-auto">
                                    <a href="{{ route('admin.home.detail.pengumuman.create', ['id_provinsi' => $findRegion->slug]) }}"
