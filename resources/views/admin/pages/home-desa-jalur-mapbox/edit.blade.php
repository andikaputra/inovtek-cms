...
@section('customJs')
    <!-- Leaflet JS -->
    @include('admin.pages.home-desa-jalur-mapbox.js._edit_js')
@endsection
                ...
                <div class="card-body">
                    <section id="basic-horizontal-layouts">
                        <form class="form form-horizontal"
                            action="{{ route('admin.home.detail.desa.segmentasi-mapbox.jalur.update', ['id_provinsi' => $findRegion->slug, 'id_desa' => $findDetailRegion->slug, 'id_mapbox' => $findDetailRegionMapbox->id, 'id' => $findDetailRegionMapboxList->id]) }}"
                            method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="form-body">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" required
                                                    ...
                                                    value="{{ old('name') ?? $findDetailRegionMapboxList->name }}">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" required class="form-control"
                                                    placeholder="Latitude dan Longitude" id="lat_long"
                                                    value="{{ $findDetailRegionMapboxList->latitude . ', ' . $findDetailRegionMapboxList->longitude }}"
                                                    name="lat_long">
                                                <div class="form-control-icon">
                                    ...
                                    <div class="col-12 col-md-2 mt-2">
                                        <div class="form-check form-check-lg d-flex align-items-end mt-4">
                                            <input class="form-check-input me-2" type="checkbox" name="is_active"
                                                ...
                                                {{ $findDetailRegionMapboxList->is_active ? 'checked' : '' }}>
