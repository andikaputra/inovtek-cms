...
@section('title', 'Dashboard Desa | Data Desa')

@section('customJs')
    @include('admin.pages.home-desa.js._index_js')
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Dashboard Desa - Data Desa</h3>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item text-subtitle"><a
                                    href="{{ route('admin.home.detail.desa.index', $findRegion->slug) }}">Dashboard Desa</a>
                            </li>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body pt-3 pb-2">
                            <div class="row justify-content-between   g-2">
                                <div class="col-auto">
                                    <h6 class="py-0">Total Desa (<span id="desa-total"><small>...</small></span>) | Aktif
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row justify-content-between g-2">
                                <div class="col-auto">
                                    <a href="{{ route('admin.home.detail.desa.create', $findRegion->slug) }}"
