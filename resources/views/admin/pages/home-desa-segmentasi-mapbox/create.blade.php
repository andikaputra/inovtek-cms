...
@section('title', 'Mapbox Desa ' . $findDetailRegion->village . ' | Buat Titik')
...
@section('customJs')
    <!-- Leaflet JS -->
    @include('admin.pages.home-desa-segmentasi-mapbox.js._create_js')
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Segmentasi Mapbox - Buat Titik</h3>
                </div>
                ...
                <div class="card-body">
                    <section id="basic-horizontal-layouts">
                        <form class="form form-horizontal"
                            action="{{ route('admin.home.detail.desa.segmentasi-mapbox.store', ['id_provinsi' => $findRegion->slug, 'id_desa' => $findDetailRegion->slug]) }}"
                            method="POST">
                            @csrf
                            <div class="form-body">
                                <div class="row">
