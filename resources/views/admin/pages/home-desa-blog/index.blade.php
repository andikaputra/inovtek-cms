...
@section('title', 'Artikel Wilayah | Data Artikel')

@section('customJs')
    @include('admin.pages.home-desa-blog.js._index_js')
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Artikel Wilayah - Data Artikel</h3>
                </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body pt-3 pb-2">
                            <div class="row justify-content-between g-2">
                                <div class="col-auto">
                                    <h6 class="py-0">Total Artikel (<span id="blog-total"><small>...</small></span>) |
                                        Aktif (<span id="active-total"><small>...</small></span>) |
                                        Nonaktif (<span id="inactive-total"><small>...</small></span>)
                                    </h6>
                                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row justify-content-between g-2">
                                <div class="col-auto">
                                    <a href="{{ route('admin.home.detail.blog.create', ['id_provinsi' => $findRegion->slug]) }}"
                                ...
                                <table class="table table-striped" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Konten</th>
                                            <th>Tag</th>
                                            <th>Tampilkan Di Tentang Inovtek</th>
