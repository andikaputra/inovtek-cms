...
@section('title', 'Pengumuman | Ubah Pengumuman')
    ...
    <div class="page-heading">
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Pengumuman - Ubah Pengumuman</h3>
                </div>
        ...
        <section class="section">
            ...
            <form class="form form-horizontal"
                action="{{ route('admin.home.detail.pengumuman.update.content', ['id_provinsi' => $findRegion->slug, 'id' => $findPengumuman->id]) }}"
                method="POST">
                @csrf
                @method('PATCH')
                <div class="row">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" required
                                                            ...
                                                            placeholder="Judul"
                                                            value="{{ old('name') ?? $findPengumuman->name }}"
                                                            name="name">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="url" required
                                                            ...
                                                            value="{{ old('announcement_link') ?? $findPengumuman->announcement_link }}"
