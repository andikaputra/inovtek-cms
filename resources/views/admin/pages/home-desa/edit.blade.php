...
@section('title', 'Dashboard Desa | Ubah Desa')
...
@section('customJs')
    <!-- Leaflet JS -->
    @include('admin.pages.home-desa.js._edit_js')
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Dashboard Desa - Ubah Desa</h3>
                </div>
                ...
                <div class="card-body">
                    <section id="basic-horizontal-layouts">
                        <form class="form form-horizontal"
                            action="{{ route('admin.home.detail.desa.update', ['id_provinsi' => $findRegion->slug, 'id' => $findDetailRegion->slug]) }}"
                            method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="form-body">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" required
                                                    ...
                                                    placeholder="Desa/Kelurahan" name="village"
                                                    value="{{ old('village') ?? $findDetailRegion->village }}">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text"
                                                    ...
                                                    value="{{ old('map_url') ?? $findDetailRegion->map_url }}">
                                                <div class="form-control-icon">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" required class="form-control"
                                                    ...
                                                    value="{{ $findDetailRegion->latitude . ', ' . $findDetailRegion->longitude }}">
                                                <div class="form-control-icon">
                                    ...
                                    <div class="col-12 col-md-6 mt-2">
                                        <div class="form-check form-check-lg d-flex align-items-end mt-4">
                                            <input class="form-check-input me-2" type="checkbox" name="is_active"
                                                ...
                                                {{ $findDetailRegion->is_active == true ? 'checked' : '' }}>
                                            <label class="form-check-label text-gray-600" for="is_active">
                                                Aktifkan Desa/Kelurahan
                                            </label>
                                        </div>
                                    </div>
