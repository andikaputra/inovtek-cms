    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            <form class="form form-horizontal"
                action="{{ route('admin.home.detail.desa.segmentasi-mapbox.order-update', ['id_provinsi' => $findRegion->slug, 'id_desa' => $findDetailRegion->slug]) }}"
                method="POST">
                @csrf
                <input type="hidden" name="route_order" id="route_order" value="">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalSesuaikanRute">
                        Sesuaikan Urutan Rute Aktif - Segmentasi Mapbox
                    </h5>
