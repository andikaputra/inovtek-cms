...
@section('title', 'Kuis Wilayah | Buat Kuis Wilayah')
    ...
    <div class="page-heading">
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Kuis Wilayah - Buat Kuis Wilayah</h3>
                </div>
        ...
        <section class="section">
            ...
            <form class="form form-horizontal"
                action="{{ route('admin.home.detail.kuis.store', ['id_provinsi' => $findRegion->slug]) }}" method="POST">
                @csrf
                <div class="row">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="url" required
                                                            ...
                                                            placeholder="Tautan Kuis" value="{{ old('quiz_link') ?? null }}"
                                                            name="quiz_link">
                                                        <div class="form-control-icon">
