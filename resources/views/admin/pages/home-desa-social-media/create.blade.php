...
@section('title', 'Sosial Media Wilayah | Buat Sosial Media')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Sosial Media Wilayah - Buat Sosial Media</h3>
                </div>
                ...
                <div class="card-body">
                    <section id="basic-horizontal-layouts">
                        <form class="form form-horizontal"
                            action="{{ route('admin.home.detail.sosial-media.store', $findRegion->slug) }}" method="POST">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="url" required
                                                        ...
                                                        placeholder="Url" value="{{ old('url') ?? null }}" name="url">
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="text" required
                                                        ...
                                                        placeholder="Display" value="{{ old('display') ?? null }}"
                                                        name="display">
                                                    <div class="form-control-icon">
