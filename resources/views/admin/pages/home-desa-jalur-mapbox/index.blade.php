...
@section('customJs')
    @include('admin.pages.home-desa-jalur-mapbox.js._index_js')
@endsection
...
@section('main')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Jalur {{ $findDetailRegionMapbox->name }} - Data Titik</h3>
                </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body pt-3 pb-2">
                            <div class="row justify-content-between   g-2">
                                <div class="col-auto">
                                    <h6 class="py-0">Total Jalur Mapbox (<span id="desa-total"><small>...</small></span>)
                                        |
                                        Aktif
                        ...
                        <div class="col-md-7 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row justify-content-between g-2">
                                        <div class="col-auto">
                                            <a href="{{ route('admin.home.detail.desa.segmentasi-mapbox.jalur.create', ['id_provinsi' => $findRegion->slug, 'id_desa' => $findDetailRegion->slug, 'id_mapbox' => $findDetailRegionMapbox->id]) }}"
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-warning text-white btn-sm icon-left"
                                                ...
                                                data-url_mapbox="{{ route('admin.home.detail.desa.segmentasi-mapbox.jalur.order-list', ['id_provinsi' => $findRegion->slug, 'id_desa' => $findDetailRegion->slug, 'id_mapbox' => $findDetailRegionMapbox->id]) }}"
                                                data-bs-target="#modalSesuaikanRute" id="loadDataMapboxButton">
                                                <i class="bi bi-list-ol"></i> Sesuaikan Rute
                                            </a>
                                        </div>
                                        <div class="col-auto">
                                        </div>
    ...
    @include('admin.pages.home-desa-jalur-mapbox.modal._sesuaikan_rute_modal')
@endsection
