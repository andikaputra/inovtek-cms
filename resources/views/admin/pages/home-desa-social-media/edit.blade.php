...
@section('title', 'Sosial Media Wilayah | Ubah Sosial Media')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Sosial Media Wilayah - Ubah Sosial Media</h3>
                </div>
                ...
                <div class="card-body">
                    <section id="basic-horizontal-layouts">
                        <form class="form form-horizontal"
                            action="{{ route('admin.home.detail.sosial-media.update.content', ['id_provinsi' => $findRegion->slug, 'id' => $findLink->id]) }}"
                            method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="form-body">
